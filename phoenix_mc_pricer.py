...
OBSERVATIONS: tuple[Observation, ...] = (
    Observation("2027-03-15", 0.2957, 0.99305, "coupon"),
    Observation("2027-06-15", 0.5476, 0.98619, "coupon"),
    Observation("2027-09-15", 0.7995, 0.97857, "coupon"),
    Observation("2027-12-15", 1.0486, 0.97035, "coupon_autocall"),
    Observation("2028-03-15", 1.2977, 0.96319, "coupon"),
    Observation("2028-06-15", 1.5496, 0.95591, "coupon"),
    Observation("2028-09-15", 1.8015, 0.94841, "coupon"),
    Observation("2028-12-15", 2.0507, 0.94111, "coupon_autocall"),
    Observation("2029-03-15", 2.2971, 0.93405, "coupon"),
    Observation("2029-06-15", 2.5489, 0.92709, "coupon"),
    Observation("2029-09-15", 2.8008, 0.91992, "coupon"),
    Observation("2029-12-15", 3.0500, 0.91284, "coupon_autocall"),
    Observation("2030-03-15", 3.2964, 0.90614, "coupon"),
    Observation("2030-06-15", 3.5483, 0.89902, "coupon"),
    Observation("2030-09-15", 3.8001, 0.89225, "coupon"),
    Observation("2030-12-15", 4.0493, 0.88525, "coupon_autocall"),
    Observation("2031-03-15", 4.2957, 0.87871, "coupon"),
    Observation("2031-06-15", 4.5476, 0.87168, "coupon"),
    Observation("2031-09-15", 4.7995, 0.86507, "coupon"),
    Observation("2031-12-15", 5.0486, 0.85815, "final"),
)
